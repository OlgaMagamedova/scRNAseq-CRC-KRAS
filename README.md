...
```bash
git clone https://github.com/your-username/scRNAseq_CRC_KRAS.git
cd scRNAseq_CRC_KRAS
```

### 2. Создать окружение

```bash
conda create -n crc_kras python=3.11
conda activate crc_kras
```

### 3. Установить зависимости

```bash
pip install scanpy celltypist pertpy gseapy liana cell2cell hotspot drug2cell blitzgsea
```

### 4. Запустить Jupyter Notebook

```bash
jupyter notebook scRNAseq_CRC_KRAS.ipynb
```
